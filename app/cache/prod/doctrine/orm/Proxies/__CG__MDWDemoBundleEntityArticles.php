 ...
 */
class Articles extends \MDW\DemoBundle\Entity\Articles implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'author', 'content', 'tags', 'created', 'updated', 'slug', 'category');
        }
