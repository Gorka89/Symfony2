	  ...
	  default:
	     ...
	     break;
			...
			if ($error_exist==0) {
				...
				$STRING .= '<votacion title="'.$question.'" id="ids" bColor="#FFFFFF" tColor="#'.$questioncolor.'" resultxml="http://admin.espartapp.com/modules/xmls/resultsVoting.xml" 
				sendto="http://admin.espartapp.com/modules/resultVote.php">';
				...
				//se vuelca a fichero
				$fp = fopen("xmls/resultVote.xml","w");
				...
				//fwrite($fp, $STRING);
				 ...
				 $fp = fopen("xmls/resultsVoting.xml","w");
				fwrite($fp, $STRING . PHP_EOL);
				fclose($fp);
